...
$con.='<a href="./index.php?my=add" class="btn btn-primary btn-sm">添加记录</a>';
echo $con;
?>
...
{
echo '<tr><td><input type="checkbox" name="checkbox[]" value="'.$res['id'].'"> '.htmlspecialchars($res['domain']).'</td><td>'.($res['type']==2?'<font color="black">黑名单</font>':'<font color="orange">白名单</font>').'</td><td>'.$res['date'].'</td><td><a href="./index.php?my=del&id='.$res['id'].'" class="btn btn-xs btn-danger" onclick="return confirm(\'你确实要删除此记录吗？\');">删除</a></td></tr>';
}
?>
          </tbody>
        </table>
