...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">优启梦防洪安装向导</span>
      </div><!-- /.navbar-header -->
    </div><!-- /.container -->
  </nav><!-- /.navbar -->
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">优启梦防洪</h3>
	</div>
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			if(DB::query("select * from frame_host where 1")==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过优启梦防洪</div>
...
/*邮箱配置*/
\$mail=array(
	'smtp' => 'smtp.exmail.qq.com', //smtp地址
	'port' => 25, //端口
	'name' => 'admin@uomg.com', //邮箱帐号
	'pass' => 'password', //邮箱密码
	'key' => 'www.uomg.com', //监控密钥
	'addressee' => 'root@uomg.com' //接收邮箱
);
?>";
...
if($domain==NULL ){
	...
	if($ad){
		...
		echo '<div class="alert alert-info"><font color="green">安装完成！管理账号和密码是:admin/admin</font><br><font color="green">config.php文件中修改。</font><br><br><a href="../">&gt;&gt;网站首页</a><hr>请在config.php中填写邮箱信息<br><font color="blue">监控地址:http://'.$domain.'/cron.php?key=密钥。</font><br><br><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！</font></div>';
	}else{
